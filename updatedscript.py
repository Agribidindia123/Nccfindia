...
JSON_DIR = BASE_DIR / "Json_data/Updated json with auth login chnages"
...
def generate_html(summary):
    ...
    .summary{background:#fff;padding:20px;border-radius:10px;box-shadow:0 2px 6px rgba(0,0,0,0.1);width:50%;margin-bottom:20px;}
    ...
    """
    total, passed, failed, skipped = summary["total"], summary["passed"], summary["failed"], summary["skipped"]
    ...
    <body>
      ...
      <div class='summary'>
        ...
        <table>
          ...
          <tr><td style='color:#856404;'>⚠️ Skipped</td><td>{skipped}</td></tr>
        </table>
      </div>
